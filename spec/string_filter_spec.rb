...
describe 'Chaotic::Filters::StringFilter' do
  ...
  it 'strips' do
    sf = Chaotic::Filters::StringFilter.new(strip: true)
    filtered, errors = sf.filter(' hello ')
    assert_equal 'hello', filtered
    assert_equal nil, errors
  end
  ...
  it 'doesn\'t strip' do
    sf = Chaotic::Filters::StringFilter.new(strip: false)
    filtered, errors = sf.filter(' hello ')
    assert_equal ' hello ', filtered
    assert_equal nil, errors
  end
  ...
  it 'considers nil to be invalid' do
    sf = Chaotic::Filters::StringFilter.new(nils: false)
  ...
  it 'considers nil to be valid' do
    sf = Chaotic::Filters::StringFilter.new(nils: true)
    filtered, errors = sf.filter(nil)
    assert_equal nil, filtered
    assert_equal nil, errors
  end
  ...
  it 'considers empty strings to be invalid' do
    sf = Chaotic::Filters::StringFilter.new(empty: false)
  ...
  it 'considers empty strings to be valid' do
    sf = Chaotic::Filters::StringFilter.new(empty: true)
    filtered, errors = sf.filter('')
    assert_equal '', filtered
    assert_equal nil, errors
  end
  ...
  it 'considers long strings to be invalid' do
    sf = Chaotic::Filters::StringFilter.new(max_length: 5)
  ...
  it 'considers short strings to be invalid' do
    sf = Chaotic::Filters::StringFilter.new(min_length: 5)
  ...
  it 'considers bad matches to be invalid' do
    sf = Chaotic::Filters::StringFilter.new(matches: /aaa/)
  ...
  it 'considers non-inclusion to be invalid' do
    sf = Chaotic::Filters::StringFilter.new(in: %w(red blue green))
  ...
  it 'converts symbols to strings' do
    sf = Chaotic::Filters::StringFilter.new(strict: false)
  ...
  it 'disallows symbols' do
    sf = Chaotic::Filters::StringFilter.new(strict: true)
    filtered, errors = sf.filter(:my_sym)
    assert_equal :my_sym, filtered
    assert_equal :string, errors
  end
  ...
  it 'removes unprintable characters' do
    sf = Chaotic::Filters::StringFilter.new(allow_control_characters: false)
  ...
  it "doesn't remove unprintable characters" do
    sf = Chaotic::Filters::StringFilter.new(allow_control_characters: true)
    filtered, errors = sf.filter("Hello\u0000\u0000World!")
    assert_equal "Hello\u0000\u0000World!", filtered
    assert_equal nil, errors
  end
