...
describe 'Chaotic::ArrayFilter' do
  it 'allows arrays' do
    f = Chaotic::ArrayFilter.new(:arr)
  ...
  it 'considers nil to be invalid' do
    f = Chaotic::ArrayFilter.new(:arr, nils: false)
  ...
  it 'lets you use a block to supply an element filter' do
    f = Chaotic::ArrayFilter.new(:arr) { string }
  ...
  it 'lets you array-ize everything' do
    f = Chaotic::ArrayFilter.new(:arr, arrayize: true) { string }
  ...
  it 'lets you pass integers in arrays' do
    f = Chaotic::ArrayFilter.new(:arr) { integer min: 4 }
  ...
  it 'lets you pass floats in arrays' do
    f = Chaotic::ArrayFilter.new(:float) { float min: 4.0 }
  ...
  it 'lets you pass ducks in arrays' do
    f = Chaotic::ArrayFilter.new(:arr) { duck(methods: :length) }
  ...
  it 'lets you pass dates in arrays' do
    f = Chaotic::ArrayFilter.new(:arr) { date(format: '%Y-%m-%d') }
  ...
  it 'lets you pass files in arrays' do
    ...
    f = Chaotic::ArrayFilter.new(:arr) { file }
  ...
  it 'lets you pass booleans in arrays' do
    f = Chaotic::ArrayFilter.new(:arr) { boolean }
  ...
  it 'lets you pass model in arrays' do
    f = Chaotic::ArrayFilter.new(:arr) { model :string }
  ...
  it 'lets you pass hashes in arrays' do
    f = Chaotic::ArrayFilter.new(:arr) do
      hash do
        required do
          string :foo
          integer :bar
