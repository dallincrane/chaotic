...
describe 'Chaotic::AdditionalFilter' do
  describe 'Additional Filter' do
    ...
    class TestCommandUsingAdditionalFilters < Chaotic::Command
      required do
        sometest :first_name
    ...
    class TestCommandUsingAdditionalFiltersInHashes < Chaotic::Command
      required do
        hash :a_hash do
          sometest :first_name
        end
    ...
    class TestCommandUsingAdditionalFiltersInArrays < Chaotic::Command
      required do
        array :an_array do
          sometest
        end
    ...
    class TestCommandUsingBlockArgument < Chaotic::Command
      required do
